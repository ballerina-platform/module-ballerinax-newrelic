...
public final class ObserveNativeImplConstants {
    ...
    public static final String METRIC_REPORTER_NAME = "newrelic";

    public static final String EXPIRY_TAG = "timeWindow";
    public static final String PERCENTILE_TAG = "quantile";
